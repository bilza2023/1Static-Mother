...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<Katex> was created with unknown prop '${key}'`);
  });
  ...
  $$self.$$set = ($$props2) => {
    if ("displayMode" in $$props2)
      $$invalidate(2, displayMode = $$props2.displayMode);
    if ("$$scope" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("latex" in $$props2)
      $$invalidate(1, latex = $$props2.latex);
  };
