...
<!-- 
<InputNumber   caption="Radius X" bind:value={selectedItem.itemData.radiusX}  
config={{min:1, max:200, step:1}}/>

<InputNumber   caption="Radius Y" bind:value={selectedItem.itemData.radiusY}  
config={{min:1, max:200, step:1}}/> -->
