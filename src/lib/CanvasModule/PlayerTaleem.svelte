<script>
/**
 *TaleemCanvas.svelte takes the taleem-canvas library and directly connects behaviour to it with out using any svelte components in between.
 
 * */    
    import { Create } from "$lib/taleem-canvas"
    import { onMount } from "svelte";
    import SingleCallBkBtnGp from "./staticEditor/components/SingleCallBkBtnGp.svelte";
    import CanvasEditorBehaviour from "./staticEditor/CanvasEditorBehaviour";
